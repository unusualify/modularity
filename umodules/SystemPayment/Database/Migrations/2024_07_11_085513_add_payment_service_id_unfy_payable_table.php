...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table(config('payable.table', 'umod_payments'), function (Blueprint $table) use ($priceTableName) {
    ...
    {
        Schema::table(config('payable.table', 'umod_payments'), function (Blueprint $table) {
