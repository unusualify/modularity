...
| [Logout Modal](../others/logout-modal) | Session / logout confirmation |
...
| [Uploader](../media/uploader) | File upload widget |

## Filters & Search

| Component | Purpose |
|-----------|---------|
| [Filter](../media/filter) | Filter bar |
...
| [Chat Message](../others/chat-message) | Chat message row |
| [Assignee Details](../others/assignee-details) | Assignee info block |
...
| [Impersonate Toolbar](../others/impersonate-toolbar) | Impersonation banner |

## Payments

| Component | Purpose |
|-----------|---------|
| [Revolut Checkout](../payments/revolut-checkout) | Revolut payment checkout integration |
