...
- **Other**: [dev](/guide/console/dev), [build](/guide/console/build), [check-collation](/guide/console/check-collation), [refresh](/guide/console/refresh), [get-version](/guide/console/get-version), [pint](/guide/console/pint), [replace-regex](/guide/console/replace-regex)
>>>>>>> Stashed changes
