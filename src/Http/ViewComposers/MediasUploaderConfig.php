...
class MediasUploaderConfig
{
    ...
    {
        $libraryDisk = $this->config->get(unusualBaseKey() . '.media_library.disk');
        $endpointType = $this->config->get(unusualBaseKey() . '.media_library.endpoint_type');
        $allowedExtensions = $this->config->get(unusualBaseKey() . '.media_library.allowed_extensions');
        ...
        $mediasUploaderConfig = [
            ...
            'acl' => $this->config->get(unusualBaseKey() . '.media_library.acl'),
            'filesizeLimit' => $this->config->get(unusualBaseKey() . '.media_library.filesize_limit'),
