...
$mediaLocalConfig = [
    'driver' => 'local',
    'visibility' => 'public',
    'root' => $localRootPrefix . trim(config('unusual.media_library.local_path'), '/ '),
];

$fileLocalConfig = [
    'driver' => 'local',
    'visibility' => 'public',
    'root' => $localRootPrefix . trim(config('unusual.file_library.local_path'), '/ '),
];
...
// dd(config('unusual.file_library.disk'));
return [
    'unusual_media_library' => $mediaConfigByEndpointType[config('unusual.media_library.endpoint_type')],
    'unusual_file_library' => $fileConfigByEndpointType[config('unusual.file_library.endpoint_type')],
];
