...
trait TwillRepeatersTrait
{
     ...
     * @return void
     */
    public function afterSaveTwillRepeatersTrait($object, $fields)
    {
     ...
     * @return array
     */
    public function getFormFieldsTwillRepeatersTrait($object, $fields)
    {
        foreach ($this->getRepeaters() as $repeater) {
    ...
    public function getFormFieldsForRepeater(
        ...
        if (! empty($repeatersMedias) && modularityConfig('media_library.translated_form_fields', false)) {
