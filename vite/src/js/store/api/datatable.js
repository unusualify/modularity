...
export default {
    ...
    */
    get (params, callback) {
        ...
        //     params
        // )
        var url = window[process.env.JS_APP_NAME].ENDPOINTS.index;
    ...
    delete (id, callback) {
        ...
        var url = window[process.env.JS_APP_NAME].ENDPOINTS.delete.replace(':id', id);
        // var url = window[process.env.JS_APP_NAME].ENDPOINTS.index.replace(':id', item.id);
